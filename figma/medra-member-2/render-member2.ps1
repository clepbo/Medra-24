...
foreach ($f in @('P0-profile-d.jsx', 'P0-profile-m.jsx', 'P2-details-d.jsx', 'P2-details-m.jsx', 'P3-dependants-d.jsx', 'P3-dependants-m.jsx', 'P4-add-dependant-d.jsx', 'P4-add-dependant-m.jsx', 'P5-security-d.jsx', 'P5-security-m.jsx', 'P6-notifs-d.jsx', 'P6-notifs-m.jsx', 'P7-language-d.jsx', 'P7-language-m.jsx', 'P8-privacy-d.jsx', 'P8-privacy-m.jsx', 'P9-delete-d.jsx', 'P9-delete-m.jsx')) { figma-cli render (Get-Content $f -Raw) }
...
foreach ($f in @('N1-notifs-d.jsx', 'N1-notifs-m.jsx', 'N2-notifs-empty-d.jsx', 'N2-notifs-empty-m.jsx', 'X1-loading-d.jsx', 'X1-loading-m.jsx', 'X2-offline-d.jsx', 'X2-offline-m.jsx', 'X3-error-d.jsx', 'X3-error-m.jsx')) { figma-cli render (Get-Content $f -Raw) }
