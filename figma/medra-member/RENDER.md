...
**729 frames is a lot to render in one sitting.** If a script stops part-way, re-run it — but
...
All four currently report **PROTOTYPE COMPLETE** — 729 frames, 642 screens, every one reachable,
no broken hotspots.
