...
foreach ($f in @('P1-create-d.jsx', 'P1-create-m.jsx', 'P2-otp-d.jsx', 'P2-otp-m.jsx', 'P3-name-d.jsx', 'P3-name-m.jsx', 'P4-about-d.jsx', 'P4-about-m.jsx', 'P5-health-d.jsx', 'P5-health-m.jsx', 'P6-login-d.jsx', 'P6-login-m.jsx', 'P7-help-d.jsx', 'P7-help-m.jsx', 'P8-success-d.jsx', 'P8-success-m.jsx')) { figma-cli render (Get-Content $f -Raw) }
