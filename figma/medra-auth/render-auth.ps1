...
foreach ($f in @('E1-onb1-d.jsx', 'E1-onb1-m.jsx', 'E2-onb2-d.jsx', 'E2-onb2-m.jsx', 'E3-onb3-d.jsx', 'E3-onb3-m.jsx', 'E4-welcome-d.jsx', 'E4-welcome-m.jsx', 'E5-role-d.jsx', 'E5-role-m.jsx')) { figma-cli render (Get-Content $f -Raw) }

# ---- Medra Auth — Member ----
figma-cli eval "(async()=>{const t=’Medra Auth — Member’;let p=figma.root.children.find(n=>n.name===t);if(!p){p=figma.createPage();p.name=t;}await figma.setCurrentPageAsync(p);return p.name;})()"
foreach ($f in @('M1-create-d.jsx', 'M1-create-m.jsx', 'M2-otp-d.jsx', 'M2-otp-m.jsx', 'M3-name-d.jsx', 'M3-name-m.jsx', 'M4-about-d.jsx', 'M4-about-m.jsx', 'M5-health-d.jsx', 'M5-health-m.jsx', 'M6-login-d.jsx', 'M6-login-m.jsx', 'M7-unlock-d.jsx', 'M7-unlock-m.jsx', 'M8-help-d.jsx', 'M8-help-m.jsx', 'M9-success-d.jsx', 'M9-success-m.jsx')) { figma-cli render (Get-Content $f -Raw) }
