...
**800 frames is a lot to render in one sitting.** If a script stops part-way, re-run it — but
...
All four currently report **PROTOTYPE COMPLETE** — 800 frames, 713 screens, every one reachable,
no broken hotspots.
